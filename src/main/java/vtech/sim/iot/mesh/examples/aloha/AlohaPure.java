...
public class AlohaPure extends AbstractGraphExample {
  ...
  final static String ALOHA_0_TITLE = "One station, 10 packets per second, 32B per packet, 250bps. Transmitter sends data at once.";
  final static String ALOHA_1_TITLE = "Two stations, 10 packets per second, 32B per packet, 250bps. Transmitter sends data at once.";
  final static String ALOHA_2_TITLE = "Four stations, 10 packets per second, 32B per packet, 250bps. Transmitter sends data at once.";
  final static String ALOHA_3_TITLE = "Eight stations, 10 packets per second, 32B per packet, 250bps. Transmitter sends data at once.";
