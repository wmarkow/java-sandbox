...
public class CSMA1NonPersistentImprovedGraphicalSimulation extends AbstractGraphExample {

    private static final long serialVersionUID = 1907903696069975751L;

    final static String WINDOW_TITLE = "CSMA 1-Nonpersistent improved transmitter simulation with Poisson traffic generator";
    ...
    private CSMA1NonPersistentImprovedSimulation sim0 = new CSMA1NonPersistentImprovedSimulation(1);
    private CSMA1NonPersistentImprovedSimulation sim1 = new CSMA1NonPersistentImprovedSimulation(2);
    private CSMA1NonPersistentImprovedSimulation sim2 = new CSMA1NonPersistentImprovedSimulation(4);
    private CSMA1NonPersistentImprovedSimulation sim3 = new CSMA1NonPersistentImprovedSimulation(8);
    private CSMA1NonPersistentImprovedSimulation sim4 = new CSMA1NonPersistentImprovedSimulation(16);
    private CSMA1NonPersistentImprovedSimulation sim5 = new CSMA1NonPersistentImprovedSimulation(32);
    private CSMA1NonPersistentImprovedSimulation sim6 = new CSMA1NonPersistentImprovedSimulation(64);
    private CSMA1NonPersistentImprovedSimulation sim7 = new CSMA1NonPersistentImprovedSimulation(97);
    private CSMA1NonPersistentImprovedSimulation sim8 = new CSMA1NonPersistentImprovedSimulation(128);
    private CSMA1NonPersistentImprovedSimulation sim9 = new CSMA1NonPersistentImprovedSimulation(256);

    public CSMA1NonPersistentImprovedGraphicalSimulation() {
	super(WINDOW_TITLE);
	sim0.init();
	sim0.start();
	sim1.init();
	...
	EventQueue.invokeLater(new Runnable() {
	    ...
	    @Override
	    public void run() {
		CSMA1NonPersistentImprovedGraphicalSimulation demo = new CSMA1NonPersistentImprovedGraphicalSimulation();
		demo.pack();
