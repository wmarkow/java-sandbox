...
public class CSMA1NonPersistentImprovedDevice extends Device {

    private PoissonGenerator generator;
    private CSMA1NonPersistentImprovedTransmitter transmitter;

    public CSMA1NonPersistentImprovedDevice(double requestsPerSecond, int dataRateBps, Medium medium,
	    int transmitterId) {
	transmitter = new CSMA1NonPersistentImprovedTransmitter(medium, transmitterId);
