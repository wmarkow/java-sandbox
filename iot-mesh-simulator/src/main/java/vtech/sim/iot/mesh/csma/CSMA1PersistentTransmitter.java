...
public class CSMA1PersistentTransmitter extends Process implements MediumListener, Transmitter {
    private final static Logger LOGGER = LoggerFactory.getLogger(CSMA1PersistentTransmitter.class);
    ...
    public CSMA1PersistentTransmitter(Medium medium, int transmitterId) {
	super();
