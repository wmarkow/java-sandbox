...
public class CSMA1NonPersistentDevice extends Device {

    private PoissonGenerator generator;
    private CSMA1NonPersistentTransmitter transmitter;
    
    public CSMA1NonPersistentDevice(double requestsPerSecond, int dataRateBps, Medium medium, int transmitterId) {
	transmitter = new CSMA1NonPersistentTransmitter(medium, transmitterId);
