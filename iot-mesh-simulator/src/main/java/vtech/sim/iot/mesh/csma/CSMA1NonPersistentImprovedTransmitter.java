...
public class CSMA1NonPersistentImprovedTransmitter extends Process implements MediumListener, Transmitter {
    private final static Logger LOGGER = LoggerFactory.getLogger(CSMA1NonPersistentImprovedTransmitter.class);
    ...
    public CSMA1NonPersistentImprovedTransmitter(Medium medium, int transmitterId) {
	super();
