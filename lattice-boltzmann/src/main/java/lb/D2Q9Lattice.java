...
/**
 * D2Q9 regular lattice. This class is implemented in terms of a regular array
 * of Cell objects.
 */
public class D2Q9Lattice {
    ...
    public void addRectangularBoundary(int oX1, int oX2, int oY1, int oY2, CollisionOperator operator) {
