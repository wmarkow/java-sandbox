//******************************************************************
//                                                                 
//  TubeOutputCharacteristicChart.java                                               
...
public class TubeOutputCharacteristicChart extends JPanel {
	...
	try {
	    BufferedReader in = new BufferedReader(new InputStreamReader(
		    XYSeriesCollection.class.getClassLoader().getResourceAsStream("demo/wtageinf.txt")));
	...
	JFreeChart chart = ChartFactory.createXYLineChart(null, "Age in Months", "Weight (kg)", dataset,
