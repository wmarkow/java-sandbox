...
import com.github.wmarkow.distiller.ui.fragment.ArchiveDataBrowserFragment;

import dagger.Component;

@PerFragment
@Component(modules = { UseCasesModule.class, FragmentPresentersModule.class}, dependencies = {ApplicationComponent.class})
public interface ArchiveDataBrowserFragmentComponent {
    ArchiveDataBrowserFragment inject(ArchiveDataBrowserFragment fragment);
}
